<template>
	<view class="medicine-detail-container">
		...
		<template v-else-if="serviceData.images">
			<view class="medicine-image-container">
				<image class="medicine-image" :src="serviceData.images" />
			</view>
			<view class="medicine-info">
				<view class="medicine-name">{{ serviceData.name }}</view>
				<view class="medicine-description" v-html="serviceData.description"></view>
			</view>
		</template>
		<template v-else>
...
<script setup>
	...
	const getServiceData = async (id) => {
		try {
			...
			const res = await getService(data)
